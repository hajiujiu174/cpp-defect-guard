...
AnalysisResult analyze_project(const ScanResult&, const std::string&, const ScanContext&, unsigned, const std::map<std::string,std::string>&,const std::vector<std::string>&,const std::string&) {
